...
describe("Batch", function()
    it("should create and write a batch", function()
        ...
        -- add two items
        local batch1 = Batch.new()
        batch1:set("item1", "dog")
        batch1:set("item2", "cat")

        batch1:execute(cStore)
        ...
        local batch2 = Batch.new()
        batch2:set("item1", "cat")
        batch2:delete("initialItem")
        batch2:delete("item2")
        batch2:execute(cStore)
        local batchedItems = cStore:getPrefix("item")
